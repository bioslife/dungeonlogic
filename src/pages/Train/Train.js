...
import {loadLevel, setStage, clickBlock, setMode, restart} from '../../actions/train';

// Images:
import flask from "../Game/Interface/flask.png"
...
class Train extends Component {
	...
	render() {
		if (this.props.game.message) {
			var message = (
				<div className="game-message">
					<div className="game-message__icon">
						<img src={skull} alt=""/>
					</div>
					<div>
						<div className="game-message__title">
							{tr(this.props.game.message.title)}
						</div>
						<div className="game-message__content">
							{tr(this.props.game.message.content)}
						</div>
					</div>
				</div>
			)
